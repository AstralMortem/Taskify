...
class StorageService:
    ...
    async def upload_file(self, file: UploadFile, object_key: str | None = None, **kwargs) -> FileUploadResponse:
        ...
        try:
            ...
            raise TaskifyException(status.HTTP_500_INTERNAL_SERVER_ERROR, "Unable to upload file", "Unable to upload file to s3 server", debug=e)
    ...
    async def generate_presigned_url(self, object_key: str,  expiration: int = 3600) -> str:
        try:
            ...
            raise TaskifyException(status.HTTP_500_INTERNAL_SERVER_ERROR, "Unable to generate file object url", debug=e)
